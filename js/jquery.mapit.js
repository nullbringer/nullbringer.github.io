...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			address: '<div class="map-icon"><h2 class="ultrabold dark f-normal t-center uppercase">The Muoi Studio</span></h2><p class="light gray2 lato">849 Strawberry Ave. Athens, GA 30605</p></div>',
			styles: 'GRAYSCALE',
			origins: [
				['37.936294', '23.947394'],
				['37.975669', '23.733868']
